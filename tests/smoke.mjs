...
expect(sw.includes("const CACHE = 'devis-acj-v30';"),'Le cache PWA doit être v30');
for(const asset of ['index.html','manifest.json','ai-v17.js','auth-v29-2.js','ogust-write-v19.js','client-step-v21.js','multi-ogust-v28.js','prestation-sync-v24.js','costs-v28-1.js','ogust-units-v25.js','history-v29.js','history-delete-v29-1.js','ux-v30.js']){
...
expect(manifest.theme_color==='#ffffff','Le thème PWA v30 doit être clair');
